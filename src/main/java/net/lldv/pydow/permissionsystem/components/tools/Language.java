package net.lldv.pydow.permissionsystem.components.tools;
...
public class Language {
    ...
    public static void init() {
        messages.clear();
        PermissionSystem.getInstance().saveResource("messages.yml");
        Config m = new Config(PermissionSystem.getInstance().getDataFolder() + "/messages.yml", Config.YAML);
